_: {
  environment.variables.NEWT_COLORS = ''
    ...
    title=#FF00FF,#000000
    button=#000000,#FF00FF
    button_active=#000000,#FFFF00
    actbutton=#FFFF00,#000000
    compactbutton=#FFFF00,#000000
    checkbox=#FF0000,#000000
    entry=#00FF00,#000000
    disentry=#000000,#000000
    textbox=#00FF00,#000000
    acttextbox=#FF00FF,#000000
    label=#00FFFF,#000000
    listbox=#00FF00,#000000
    actlistbox=#FF00FF,#000000
    sellistbox=#FF0000,#000000
    actsellistbox=#000000,#FFFF00
  '';
